...
import net.teamfruit.skcraft.launcher.i18n.I18n;
...
public final class Launcher {
	...
	@Getter
	private final LauncherArguments options;
	@Getter
	...
	@Getter
	final private RemoteSkinList remoteSkins;
	@Getter
	@Setter
	private Skin skin = new DefaultSkin(this);
	@Getter
	...
	@Getter
	private final UriScheme uriScheme = new UriScheme(this);
	 ...
	 */
	public Launcher(@NonNull Class<?> mainClass, @NonNull LauncherArguments options, @NonNull String[] args,
			@NonNull final File argBaseDir) throws IOException {
	 ...
	 */
	public Launcher(@NonNull Class<?> mainClass, @NonNull LauncherArguments options, @NonNull String[] args,
			@NonNull final File argBaseDir, @NonNull final File argConfigDir) throws IOException {
		...
		this.directories = new ConfigLauncherDirectories(this.config) {
			@Getter
			private final File configDir = argConfigDir;
			@Getter
			private final File baseDir = argBaseDir;
		};
	 ...
	 */
	public static Launcher createFromArguments(@NonNull Class<?> mainClass, String[] args)
